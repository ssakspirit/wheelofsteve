...
execute if score .seq global matches 1205 if score .time_mode global matches 1 run event entity @e[type=rwm:timer] rwm:timer_time_50
execute if score .seq global matches 1205 if score .time_mode global matches 2 run event entity @e[type=rwm:timer] rwm:timer_time_70
