...
clone -3 62 3021 -3 62 3021 2 61 3018
fill 2 61 3018 2 61 3018 air destroy
kill @e[type=item,name=chest]
tp @e[type=item,x=2,y=61,z=3018,r=2] 10 61 3023
function utility/games/craft/crafting/team2_grid_clear
execute as @a[scores={team=2}] run playsound note.harp @a[scores={team=2}] ~ ~ ~ 1 2